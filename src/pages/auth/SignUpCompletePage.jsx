...
import signUpCompletePrf from "../../assets/icon/signUpCompletePrf.svg";
import signUpCompleteCheckPrf from "../../assets/icon/signUpCompleteCheckPrf.svg";
import prfClock from "../../assets/icon/prfClock.svg";
import prfClockPending from "../../assets/icon/prfClockPending.svg";
...
function SignUpCompletePage() {
  ...
  return (
    <div
      className={
        styles[
          `${isProfessor ? "signup-prf-complete-ct" : "signup-total-complete-ct"}`
        ]
      }
    >
      <div className={styles["signup-complete-ct"]}>
        <article className={styles["sign-complete-user-ct"]}>
          ...
          <img
            src={`${isProfessor ? signUpCompleteCheckPrf : signUpCompleteCheck}`}
          />
          <img
            src={`${isProfessor ? signUpCompletePrf : signUpCompleteUser}`}
          />
          <p> {name} </p>
          {isProfessor ? (
            <>
              <div className={styles["sign-complete-level-prf-ct"]}>
                <img src={prfClock} />
                <p> 강사 승인 대기중</p>
              </div>
        ...
        <article className={styles["sign-complete-instructions-ct"]}>
          {isProfessor ? (
            <>
              <div className={styles["sign-complete-instructions-prf-top"]}>
                <img src={prfClockPending} />
                <p> 승인 대기 중 </p>
              </div>

              <p> 신청이 완료되었습니다!</p>
              <p>관리자 승인 후 강사 기능을 이용하실 수 있습니다.</p>
              <p>
                {" "}
                제출하신 정보를 검토하는 중입니다. <br /> 승인이 완료되면 로그인
                하실 수 있습니다.
              </p>
